...
public class MyGameView extends SurfaceView implements Callback {
	...
	public void controlEffectSoundOn(){
		gt.OnOffEffectSound();
	}
	
	public void controlEffectSoundOff(){
		gt.OnOffEffectSound();
	}
	
	public void controlBgmOn(){
		gt.pauseNResumeBGM();
		b= true;
	}
	
	public void controlBgmOff(){
		gt.pauseNResumeBGM();
		b = false;
	}
	...
	class GameThread extends Thread{
		...
		public void BGM(boolean isstart){
			if(isstart == true){
				m_sound_play_id1=m_sound_pool.play(m_sound_id1, 1, 1, 0, 0, 1);
			}else if(isstart == false){
				//m_sound_play_id1=m_sound_pool.play(m_sound_id1, 0, 0, 0, 0, 1);
				//m_sound_pool.pause(m_sound_id1);
				m_sound_pool.stop(m_sound_id1);
			}
